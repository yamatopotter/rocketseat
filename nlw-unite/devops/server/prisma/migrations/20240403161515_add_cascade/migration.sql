...
CREATE TABLE "new_attendees" (
    ...
    CONSTRAINT "attendees_event_public_id_fkey" FOREIGN KEY ("event_public_id") REFERENCES "events" ("public_id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_attendees" ("created_at", "email", "event_public_id", "id", "name") SELECT "created_at", "email", "event_public_id", "id", "name" FROM "attendees";
